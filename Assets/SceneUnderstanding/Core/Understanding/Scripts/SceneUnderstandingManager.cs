...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManager : MonoBehaviour
    {
        ...
        public bool DisplayScanPlanes = false;
...
#pragma warning restore CS4014
        ...
        {
            // MyCodeスキャンはStartボタンを押した時のみ
            if (DisplayScanPlanes)
            {
                DisplayScanPlanes = false;
                try
                {
        ...
        private IEnumerator DisplayDataRoutine(TaskCompletionSource<bool> completionSource)
        {
            ...
            if (cachedDeserializedScene != null)
            {
                ...
                ScoreDisplay.GetComponent<CalScore>().TimerStart();
        ...
        private List<GameObject> CreateSUObjectInUnity(SceneUnderstanding.SceneObject suObject)
        {
            ...
            //Create the Quad SceneObjects first
            {
                ...
                foreach (SceneUnderstanding.SceneQuad quad in suObject.Quads)
                {
                    ...
                    //Material tempMaterial = (Material)Resources.Load("whiteboard");
                    ...
                    gameObjectToReturn.AddComponent<MeshCollider>();
                    Destroy(unityMesh);
                    ...
                    //GameObject gameObjectToReturn = Instantiate(obj);
                    //Vector3 size = new Vector3(quad.Extents.X, quad.Extents.Y, (float)0.01);
                    //gameObjectToReturn.transform.localScale = size;

                    //gameObjectToReturn.layer = layer;
                    //gameObjectToReturn.AddComponent<MeshFilter>();
                    //MeshFilter mf = gameObjectToReturn.AddComponent<MeshFilter>();
                    ...
                    //};
                    //GameObjectExtension.AddInkCanvas(gameObjectToReturn, paintSet);
                    //gameObjectToReturn.SetActive(true);
                    //Component[] components = gameObjectToReturn.GetComponents<Component>();
                    ...
                    Destroy(gameObjectToReturn.GetComponent<MeshFilter>().mesh);
